                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <div class="doctor-details mt-4 mt-lg-0">
                            ...
                            <p>Berdasarkan Keluhan yang telah anda ajukan ke kami melalui kuesioner sistem, maka kami
                                menfonis anda mengalami
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">: {{ $diagnosa->pasien->kelamins->js_kelamin }}
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">:
                                                    {{ Carbon\Carbon::now()->format('l, d F Y - H:i') }} </div>
                                            </div>
                                            <hr>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <p><strong> Anda Menderita Penyakit (<u>
                                                        {{ $diagnosa->penyakit->nama }}</u>).</strong></p>
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <label>Tingkat keseriusan penyakit :
                                                        <b>{{ $diagnosa->persentase }}%</b></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-9">
                                                    <p style="text-align:justify;">
                                                        {{ $diagnosa->penyakit->definisi or 'Belum ada penjelasan lengkap mengenai penyakit ini.' }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <p style="text-align:justify;">{{ $diagnosa->penyakit->penyebab }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <p style="text-align:justify;">
                                                        {{ $diagnosa->penyakit->solusis->nama_solusi }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <a href="{{ url('/home') }}" class="btn btn-success btn-round-full mt-3"
                                style="marin-top:20px;">Selesai <i class="icofont-simple-right ml-2  "></i></a>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-info">
                    ...
                    <p>Malaria merupakan penyakit yang disebabkan oleh parasit Plasomodium. Penyakit ini ditularkan
                        melalui gigitan nyamuk Anopheles betina yang terinfeksi parasit tersebut. </p>
