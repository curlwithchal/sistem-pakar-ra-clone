            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
                        ...
                        <p class="mb-4">Perhatian..!, Bagi pasien yang ingin melakukan konsultasi masalah keluhan yang
                            dialami, terlebih dulu melakukan
                        ...
                        <form id="#" class="appoinment-form" method="post" action="{{ route('storePasien') }}">
                            ...
                            <button type="submit" class="btn btn-primary"> Kirim & Lanjut Konsultasi<i
