		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<h2>Biografi Dokter</h2>
					<div class="divider mx-auto my-4"></div>
					<p>Dokter merupakan tenaga medis yang sangat diperlukan dalam kehidupan manusia, sesaui dengan kinerja dokter, semua dokter 
                        yang dapat menangani pasien harus sudah mendapat izin atau lisensi untuk menangani pasien. melalui biografi dokter pasien dapat 
                        memilih dokter sesaui kemauan pasien.
                    </p>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					...
					<div class="content">
						...
						<a href="department-single.html" class="read-more">Selanjutnya<i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
